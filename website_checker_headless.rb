...
begin
    ...
    if page_title != expected_title
        # puts "Something is wrong with the page title. Please check!"
    ...
    #puts "Website Body Content is displayed."
    ...
    #puts "Website Footer Content is displayed."

    # puts "Website is up and running: #{website_url}"
...
# There may be times where initially the website opens when you do it manually, but when refreshed, an error occurs.
    ...
    # puts "Selenium::WebDriver::Error::UnknownError: Website is down!"
